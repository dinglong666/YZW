...
class Common_util_pub
{
	...
	public $NOTIFY_URL = 'http://cyrb.5carcar.com/Home/Wxpay/notify';
	...
	function __construct($config) {
		...
		if(isset($config['appid'])){
			...
			//=======【基本信息设置】=====================================
			//微信公众号身份的唯一标识。审核通过后，在微信发送的邮件中查看
			$this->APPID = 'wx0c22ec17b3f0d2b9';
			//受理商ID，身份标识
			$this->MCHID = '1390917802';
			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
			$this->KEY = 'tdreammasongxuesongchaoqunkuange';
			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
			$this->APPSECRET = '23e3f1eff1cca96327ae337abe159c6e';		
			//=======【证书路径设置】=====================================
			//证书路径,注意应该填写绝对路径
