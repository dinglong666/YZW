    ...
    <div class="header">
        <div class="ptjs-header-box">
            ...
            <ul class="ptjs-header-nav">
                <li <?php echo ($index); ?>><a href="<?php echo U('index');?>">首页</a></li>
     ...
     <nav class="col-sm-3" id="myScrollspy">
       <div class="container-fluid">
            <ul class="nav nav-pills nav-stacked"  id="dong">
               ...
               <li class="active"><a href="jingcaishipin.html">精彩视频</a></li>
             </ul>
       </div>
     </nav>
     <div class="col-sm-9 col-md-9">
     <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($i % 2 );++$i; if($key%3==0): ?><div class="clearfix"></div><?php endif; ?>
       <div class="col" style='overflow: hidden;'>
         <a href="<?php echo U('jcsp_xq?id='.$a['article_id']);?>" >
           <img src="/Uploads/<?php echo ($a["img_url"]); ?>" />
           <center><p class="jcsp-text"><?php echo ($a["title"]); ?></p></center>
         </a>
