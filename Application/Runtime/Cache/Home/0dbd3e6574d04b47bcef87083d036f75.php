...
<div class="xq-content">
  ...
  <div class="row">
     ...
     <div class="col-sm-9 col-md-9">
       <h5>您当前所在位置：精彩视频><span>视频详情</span></h5>
       <div class="xq-img">
       <?php if($find['img_chain']): echo ($info["img_chain"]); ?>

        <?php else: ?>
        <video src="__VIDEO__/<?php echo ($find["video_name"]); ?>" width="100%" height="100%"  controls="controls">
