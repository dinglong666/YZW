						...
						<div class="panel-body" style="width:50%;margin-left:20%">
							<form action="<?php echo U('News/newsList_add');?>" method="post" enctype="multipart/form-data" class="form-horizontal ">
								<div style='margin-top: 150px;' class="form-group">
				                    ...
				                    <div class="col-md-9">
                                        <textarea style='resize:none;' cols="36" rows="8" name='ntext' id="content" style="border: 1 solid #888888;LINE-HEIGHT:18px;padding: 3px;"><?php echo ($find['project_contents']); ?></textarea>
				                    </div>
				                </div>
								<br>
