					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2><i class="fa fa-table red"></i><span class="break"></span><strong>公司员工列表</strong></h2>
							...
							<table  class="table table-striped table-bordered bootstrap-datatable datatable">
								...
								<tbody>		
									<?php if(is_array($sel)): $i = 0; $__LIST__ = $sel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
											...
											<td><?php echo ($v['last_login']==0?0:date('Y-m-d',$v['last_login'])); ?></td>
											<td><?php echo date('Y-d-m',$v['reg_time']);?></td>
											<td>
												<a href="<?php echo U('Users/users_detail?id='.$v['user_id'].'&users=staff');?>">查看</a> &nbsp;
<!-- 												|&nbsp;&nbsp;
												<a onclick="return confirm('确认删除？')" href="" target="blank">删除</a> &nbsp; -->
											</td>
