...
<body>
	<!-- start: Header -->
		...
		<div class="container-fluid">		
			...
			<form action="/index.php/Admin/Article/video" method="get" class="navbar-form navbar-left">
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2><i class="fa fa-table red"></i><span class="break"></span><strong>分类文章列表</strong> | <a href="<?php echo U('Article/video_add');?>"><strong>添加视频</strong></a></h2>
							...
							<table style='height:20px' class="table table-striped table-bordered bootstrap-datatable datatable">
								...
								<tbody>		
									<?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
											...
											<td>
												<a href="<?php echo U('article/video_add?id='.$v['article_id'].'&act=upd');?>">编辑</a> &nbsp;
												|
