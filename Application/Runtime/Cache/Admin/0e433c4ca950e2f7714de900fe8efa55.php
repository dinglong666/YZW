		...
		<div class="main ">
			...
			<div class="row">
			            ...
			            <div class="panel-heading">
			                <a href="<?php echo U('Project/projectList_type');?>"><h2><i class="fa fa-indent red"></i><strong>返回列表</strong></h2></a>
			            </div>
						<div class="panel-body" style="width:50%;margin-left:20%">
							<form action="<?php echo U('ProjectList_type_up?id='.$find['type_id']);?>" method="post" enctype="multipart/form-data" class="form-horizontal ">
								<div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">项目分类名称：</label>
				                    <div class="col-md-9">
				                        <input type="text" name="pname" value="<?php echo ($find['type_name']); ?>" class="form-control" >
				                    </div>
				                </div>
				           		<div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">项目分类描述：</label>
				                    <div class="col-md-9">
				                        <input type="text" name="pdesc" value="<?php echo ($find['type_desc']); ?>" class="form-control" >
				                    </div>
				                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" value='1' name="pxs" <?php if($find['type_state'] == 1): ?>checked<?php endif; ?> >显示&nbsp;&nbsp;&nbsp;
                                        <input type="radio" value='0' name="pxs" <?php if($find['type_state'] == 0): ?>checked<?php endif; ?> >不显示
                                    </div>
                                </div>
								<br>
