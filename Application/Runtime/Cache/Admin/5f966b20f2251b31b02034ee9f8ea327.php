		...
		<div class="main ">
			...
			<div class="row">
						...
						<div class="panel-body" style="width:50%;margin-left:20%">
							<form action="<?php echo U('Admin/adminadd');?>" method="post" enctype="multipart/form-data" class="form-horizontal ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select name="qx">
                                            <?php if(is_array($qx)): $i = 0; $__LIST__ = $qx;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$x): $mod = ($i % 2 );++$i;?><option value="<?php echo ($x[role_id]); ?>"><?php echo ($x['role_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>    
                                        </select>
                                    </div>
                                </div>
				                      <input type="hidden" name="please" value="1"> 
								<br>
