...
<!-- 			
			<form action="/index.php/Admin/admin/adminlist" method="get" class="navbar-form navbar-left">
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2><i class="fa fa-table red"></i><span class="break"></span><strong>管理员列表</strong> | <a href="<?php echo U('Admin/adminadd');?>"><strong>添加管理员</strong></a></h2>
<!-- 							<div class="panel-actions">  //刷新 收回 关闭按钮
						...
						<div class="panel-body">
							<table class="table table-striped table-bordered bootstrap-datatable datatable">
								...
								<tbody>		
									<?php if(is_array($admin)): $i = 0; $__LIST__ = $admin;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
											<td><?php echo ($v["id"]); ?></td>
											<td><?php echo ($v["username"]); ?></td>
											<td><?php echo (date("Y-m-d",$v["addtime"])); ?></td>
											<td>
												<a href="<?php echo U('Admin/admindit?id='.$v['id']);?>">编辑</a> &nbsp;
											<?php if($v["role_id"] != 0): ?>|&nbsp;&nbsp;
												<a onclick="return confirm('确认删除？')" href="<?php echo U('Admin/admindel?id='.$v['id']);?>" target="blank">删除</a> &nbsp;<?php endif; ?>
											</td>
