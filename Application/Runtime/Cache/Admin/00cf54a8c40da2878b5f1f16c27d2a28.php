					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2><i class="fa fa-table red"></i><span class="break"></span><strong>广告位管理</strong> | <a href="<?php echo U('Advert/advertPosition_add');?>"><strong>添加广告位</strong></a></h2>
<!-- 							<div class="panel-actions">  //刷新 收回 关闭按钮
						...
						<div class="panel-body">
							<table style="table-layout:fixed;" class="table table-striped table-bordered bootstrap-datatable datatable">
								...
								<tbody>		
									<?php if(is_array($ad)): $i = 0; $__LIST__ = $ad;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($i % 2 );++$i;?><tr>
											<td><?php echo ($a['position_id']); ?></td>
											<td><?php echo ($a['position_name']); ?></td>
											<td><?php echo ($a['ad_width']); ?>px</td>
											<td><?php echo ($a['ad_height']); ?>px</td>
											<td style='width:100%;word-break:keep-all;white-space:nowrap;overflow: hidden'><?php echo ($a['position_desc']); ?></td>
											<td><a href="<?php echo U('Advert/advertPosition_state?id='.$a['position_id']);?>"><?php echo ($xs[$a['is_open']]); ?></a></td>
											<td>
												<a href="<?php echo U('Advert/advertPosition_up?id='.$a['position_id']);?>">编辑</a> &nbsp;
												|&nbsp;&nbsp;
												<a onclick="return confirm('确认删除？')" href="<?php echo U('Advert/advertPosition_del?id='.$a['position_id']);?>" target="blank">删除</a> &nbsp;
											</td>
