		...
		<div class="main ">
			...
			<div class="row">
						...
						<div class="panel-body" style="width:50%;margin-left:20%">
							<form action="<?php echo U('ProjectList_type_add');?>" method="post" enctype="multipart/form-data" class="form-horizontal ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" value='1' name="pxs" checked >显示&nbsp;&nbsp;&nbsp;
                                        <input type="radio" value='0' name="pxs"  >不显示
                                    </div>
                                </div>
								<br>
