		...
		<div class="main ">
			...
			<div class="row">
			            ...
			            <div class="panel-heading">
			                <a href="<?php echo U('News/newsList');?>"><h2><i class="fa fa-indent red"></i><strong>返回列表</strong></h2></a>
			            </div>
						<div class="panel-body" style="width:50%;margin-left:20%">
							<form action="<?php echo U('News/newsList_up?id='.$find['information_id']);?>" method="post" enctype="multipart/form-data" class="form-horizontal ">
								<div style='margin-top: 150px;' class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">发布消息：</label>
				                    <div class="col-md-9">
                                        <textarea style='resize:none;' cols="36" rows="8" name='ntext' id="content" style="border: 1 solid #888888;LINE-HEIGHT:18px;padding: 3px;"><?php echo ($find['information_content']); ?></textarea>
				                    </div>
				                </div>
								<br>
