					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2><i class="fa fa-table red"></i><span class="break"></span><strong>权限管理</strong> | <a href="<?php echo U('Admin/adminPower_add');?>"><strong>添加权限</strong></a></h2>
							...
							<table style="table-layout:fixed;" class="table table-striped table-bordered bootstrap-datatable datatable">
								...
								<tbody>		
									<?php if(is_array($sel)): $i = 0; $__LIST__ = $sel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
											...
											<td  style='width:100%;word-break:keep-all;white-space:nowrap;overflow: hidden'><?php echo ($v['role_desc']); ?></td>
											<td>
												<a href="<?php echo U('Admin/adminPower_up?id='.$v['role_id']);?>">编辑</a> &nbsp;
											<?php if($v["role_id"] != 0): ?>|&nbsp;&nbsp;
												<a onclick="return confirm('确认删除？')" href="<?php echo U('Admin/adminPower_del?id='.$v['role_id']);?>" target="blank">删除</a> &nbsp;<?php endif; ?>
											</td>
