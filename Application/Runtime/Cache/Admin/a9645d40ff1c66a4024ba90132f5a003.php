		...
		<div class="main ">
			...
			<div class="row">
			            ...
			            <div class="panel-heading">
			                <a href="<?php echo U('Advert/advertList');?>"><h2><i class="fa fa-indent red"></i><strong>返回列表</strong></h2></a>
			            </div>
						<div class="panel-body" style="width:50%;margin-left:20%">
							<form action="<?php echo U('Advert/advertList_up?id='.$id);?>" method="post" enctype="multipart/form-data" class="form-horizontal ">
								<div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">广告名称：</label>
				                    <div class="col-md-9">
				                        <input type="text" name="aname" value="<?php echo ($ad['ad_name']); ?>" class="form-control" >
				                    </div>
				                </div>
				           		<div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">广告位置：</label>
				                    <div class="col-md-9">
				                        <input type="text" name="aposition" value="<?php echo ($ad['pid']); ?>" class="form-control" >
				                    </div>
				                </div>
				             	<div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">开始时间：</label>
				                    <div class="col-md-9">
				                        <input type="date" name="aks"  value="<?php echo date('Y-m-d',$ad['start_time']);?>" class="form-control" >
				                    </div>
				                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">结束时间：</label>
                                    <div class="col-md-9">
                                        <input type="date" name="ajs"  value="<?php echo date('Y-m-d',$ad['end_time']);?>" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">广告链接：</label>
                                    <div class="col-md-9">
                                        <input type="text" name="aurl"  value="<?php echo ($ad['ad_link']); ?>" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">广告图片：</label>
                                    <div class="col-md-9">
                                        <img src="<?php echo (get_img($ad['img_id'])); ?>" id='previewImage'>
                                        <input type="file" name="aimg" id='file' >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">默认排序：</label>
                                    <div class="col-md-9">
                                        <input type="number" name="asort"  value="<?php echo ($ad['orderby']); ?>" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">是否显示：</label>
                                    <div class="col-md-9">
                                        <input type="radio" name="xs" value='1' <?php if($ad['enabled'] == 1): ?>checked<?php endif; ?>  >显示
                                        <input type="radio" name="xs" value='0'  <?php if($ad['enabled'] == 0): ?>checked<?php endif; ?>   >不显示
                                    </div>
                                </div>  
								<br>
