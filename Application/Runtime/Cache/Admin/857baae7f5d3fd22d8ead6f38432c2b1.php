			...
			<div class="row">
						<div class="panel-body" style="width:50%;margin-left:20%">
							<form action="<?php echo U('Article/type_add_go');?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
                                ...
                                <input type='hidden' name='cat_id' value='<?php echo ($find["cat_id"]); ?>'>
                                <input type='hidden' name='ttype' value='type_list'>
								<input type='hidden' name='ltype' value='fl'>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">文章类别:</label>
                                    <div class="col-md-9">
                                        <!-- <select name="cat_id" id="">
                                            <option value="">--请选择--</option>
                                            <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($i % 2 );++$i;?><option <?php if($find['cat_id'] == $a['cat_id']): ?>selected<?php endif; ?> value="<?php echo ($a["cat_id"]); ?>"><?php echo ($a["cat_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select> -->
                                        <?php echo ($find["list"]["cat_name"]); ?>
                                    </div>
                                </div>  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="radio" name="is_open" <?php if($find['is_open'] and $find['is_open'] == 1): ?>checked<?php endif; ?> value='1'>是
                                        <input type="radio" name="is_open" <?php if($find['is_open'] and $find['is_open'] == 0): ?>checked<?php endif; ?> value='0'>否
                                    </div>
                                </div> 
                                <?php if($find['cat_id'] == 106): ?><div class="form-group">
                                        <label class="col-md-3 control-label" for="text-input">地址:</label>
                                        <div class="col-md-9">
                                            <input type='text' name='content'  class="form-control" value='<?php echo ($find["content"]); ?>' placeholder="请填写地址">
                                        </div>
                                    </div> 
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="text-input">联系电话:</label>
                                        <div class="col-md-9">
                                            <input type='text' name='keywords'  class="form-control" value='<?php echo ($find["keywords"]); ?>' placeholder="请填写联系电话">
                                        </div>
                                    </div> 
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="text-input">邮箱:</label>
                                        <div class="col-md-9">
                                            <input type='text' name='description'  class="form-control" value='<?php echo ($find["description"]); ?>' placeholder="请填写邮箱">
                                        </div>
                                    </div><?php endif; ?>

                                <?php if($find['cat_id'] == 116): ?><div class="form-group">
                                        <label class="col-md-3 control-label" for="text-input">首页最新消息:</label>
                                        <div class="col-md-9">
                                            <input type='text' name='content' class="form-control" value='<?php echo ($find["content"]); ?>' placeholder="请填写首页最新消息">
                                            <span style="color:#888888">用大间距的空格时用<?php echo htmlspecialchars("&nbsp;");?>  <br />
                                            例:最新成交消息：总成交量7个项目<?php echo htmlspecialchars("&nbsp;"); echo htmlspecialchars("&nbsp;"); echo htmlspecialchars("&nbsp;");?>总成交额281818元</span>
                                        </div>
                                    </div><?php endif; ?>

                                <?php if(($find['cat_id'] != 105) and ($find['cat_id'] != 116)): ?><div class="form-group">
                                        <label class="col-md-3 control-label" for="text-input">图片:</label>
                                        <div class="col-md-9">
                                            <input type="file" name="photo" id="file0" value="<?php echo ($find["title"]); ?>" placeholder="请选择图片">
                                ...
                                <?php if($find['article_id'] == 1289 or $find['article_id'] == 1286 or $find['cat_id'] == 105): ?><div class="form-group">
