...
<body>
	<!-- start: Header -->
		...
		<div class="container-fluid">		
			...
			<form action="/index.php/Admin/Article/article_list" method="get" class="navbar-form navbar-left">
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2><i class="fa fa-table red"></i><span class="break"></span><strong>分类文章列表</strong> | <a href="<?php echo U('Article/article_add');?>"><strong>添加文章</strong></a></h2>
							...
							<table style='height:20px' class="table table-striped table-bordered bootstrap-datatable datatable">
								...
								<tbody>		
									<?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
											...
											<td><?php echo ($v["list"]["cat_name"]); ?></td>
											<td><?= $xianshi[$v['is_open']] ?></td>
											<td><?php echo (date("Y-m-d H:i:s",$v["add_time"])); ?></td>
											<td>
												<a href="<?php echo U('article/article_add?id='.$v['article_id'].'&act=upd');?>">编辑</a> &nbsp;
												|
												<a onclick="return confirm('确认删除？')" href="<?php echo U('Article/del?id='.$v['article_id'].'&type=sp');?>">删除</a> 
											</td>
