						...
						<div class="panel-body" style="width:50%;margin-left:20%;margin-top:10%">
							<form action="" method="post" enctype="multipart/form-data" class="form-horizontal ">
								<div style='margin-left:20%' class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">生成随机账号数量：</label>
				                    <div class="col-md-9">
				                        <input type="text" style='width:150px' name="num" class="form-control" >
				                    </div>
				                </div>
                                <div style='margin-left:20%' class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">生成统一密码：</label>
                                    <div class="col-md-9">
                                        <input type="password" style='width:150px' name="pwd" class="form-control" placeholder="密码只能为6位数字" >
                                    </div>
                                </div>
                                <div style='margin-left:20%' class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">生成统一密码再次确认：</label>
                                    <div class="col-md-9">
                                        <input type="password" style='width:150px' name="rpwd" class="form-control" placeholder="密码只能为6位数字" >
                                    </div>
                                </div>
								<br>
								   <button onclick="return confirm('确认添加？')" style="width:30%;margin-left:30%" type="submit" class="btn btn-sm btn-success"><i class="fa fa-dot-circle-o"></i>添加</button>
				            </form>
