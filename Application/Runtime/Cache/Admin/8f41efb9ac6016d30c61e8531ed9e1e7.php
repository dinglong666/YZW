...
<!-- 					<div class="copyright text-center">
		...
		<div class="main ">
			...
			<div class="row">
						...
						<div class="panel-body" style="width:50%;margin-left:20%;margin-top:10%">
							<form action="<?php echo U('Project/projectList_address');?>" method="post" enctype="multipart/form-data" class="form-horizontal ">
								<div style='margin-left:15%' class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">项目所在地：</label>
				                    <div class="col-md-9">
                                        <select style="width:150px;height:30px" name="pad">
                                ...
                                <div style='margin-left:15%' class="form-group">
                                    <label class="col-md-3 control-label" for="text-input">添加项目所在地：</label>
                                    <div class="col-md-9">
                                        <input type="text" style='width:150px' name="apad" class="form-control" >
                                    </div>
                                </div>
								<br>
								   <button onclick="return confirm('确认添加？')" style="width:30%;margin-left:30%" type="submit" class="btn btn-sm btn-success" name="add" value="add"><i class="fa fa-dot-circle-o"></i>添加</button>
                                <br>
                                <br>
                                   <button onclick="return confirm('确认删除？')" style="width:30%;margin-left:30%;background-color:red;border-color:red" type="submit" class="btn btn-sm btn-success" name="del" value="del"><i class="fa fa-dot-circle-o"></i>删除</button>
				            </form>
