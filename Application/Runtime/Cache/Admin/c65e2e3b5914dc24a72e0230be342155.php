			...
			<div class="row">
						<div class="panel-body" style="width:50%;margin-left:20%">
							<form action="<?php echo U('Article/type_add_go');?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
                                ...
                                <input type='hidden' name='ttype' value='cooperation_list'>
								<input type='hidden' name='ltype' value='qy'>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="text-input">文章摘要:</label>
                                        <div class="col-md-9">
                                            <textarea name="description" class="form-control" style="width:430px;height:100px;"><?php echo ($find["description"]); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
